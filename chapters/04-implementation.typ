...
construct, gives its VMIR encoding, and then the strategy Helium uses to verify it.
Most sections close with a comparison to Silicon, naming where the two designs
diverge and what the divergence gains.
